...
#query = "can biopolymers from fish skin be used as a wound-healing bandage?"
#query = "can artificial intelligence be used to detect early stage malignant tumors?"
query = "Ano anong courses and inooffer sa MSU-IIT?"
